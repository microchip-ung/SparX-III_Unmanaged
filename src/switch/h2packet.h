...
//#define PACKET_XTR_QU_CNT 2 //James: Orignal value is 8 but the function of rx_packet_tsk
//only handle Q0 and Q1. It causes LLDP packet not to be received
//properly. Need to confirm with Victor.

/* The lowest queue number has highest priority */

#if (PACKET_XTR_QU_CNT == 2)
#define PACKET_XTR_QU_HIGH   (VTSS_PACKET_RX_QUEUE_START + 0)
#define PACKET_XTR_QU_MEDIUM (VTSS_PACKET_RX_QUEUE_START + 1)
#define PACKET_XTR_QU_NORMAL (VTSS_PACKET_RX_QUEUE_START + 1)
#define PACKET_XTR_QU_LOW    (VTSS_PACKET_RX_QUEUE_START + 1)
...
#define PACKET_XTR_QU_LOW    (VTSS_PACKET_RX_QUEUE_START + 3)
#endif /* PACKET_XTR_QU_CNT == 4 */

#if (PACKET_XTR_QU_CNT == 8)
#define PACKET_XTR_QU_HIGH        (VTSS_PACKET_RX_QUEUE_START + 0)
#define PACKET_XTR_QU_MEDIUM_HIGH (VTSS_PACKET_RX_QUEUE_START + 1)
#define PACKET_XTR_QU_MEDIUM      (VTSS_PACKET_RX_QUEUE_START + 2)
#define PACKET_XTR_QU_MEDIUM_LOW  (VTSS_PACKET_RX_QUEUE_START + 3)
#define PACKET_XTR_QU_NORMAL_HIGH (VTSS_PACKET_RX_QUEUE_START + 4)
#define PACKET_XTR_QU_NORMAL      (VTSS_PACKET_RX_QUEUE_START + 5)
#define PACKET_XTR_QU_NORMAL_LOW  (VTSS_PACKET_RX_QUEUE_START + 6)
#define PACKET_XTR_QU_LOW         (VTSS_PACKET_RX_QUEUE_START + 7)
...
#define PACKET_XTR_QU_BPDU_LLDP PACKET_XTR_QU_MEDIUM_HIGH
