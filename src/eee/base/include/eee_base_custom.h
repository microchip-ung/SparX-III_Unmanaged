...
#define EEE_NO_OF_PORTS NO_OF_PORTS
...
#define eee_api_conf_set(iport, conf) h2_eee_port_conf_set(iport, conf);

//Define function for getting link partner auto negotiation result
#define eee_link_partner_advertisements_get(iport, lp_advertisement) vtss_phy_eee_link_partner_advertisements_get(iport, lp_advertisement)
