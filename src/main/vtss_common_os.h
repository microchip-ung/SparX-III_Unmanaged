...
extern void vtss_vprintf(const char *fmt, va_list ap);
extern void vtss_printf(const char *fmt, ...);
...
#define PROTO2OSINT(PORTNO)             port2int(PROTO2OSEXT(PORTNO))
...
#define OSINT2PROTO(PORTNO)             OSEXT2PROTO(port2ext(PORTNO))
 ...
 */
extern vtss_common_pwr_mngr_t vtss_os_get_link_pwr_mngr_mode(vtss_common_port_t portno);
