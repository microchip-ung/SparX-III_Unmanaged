...
void h2_fan_conf_set(const vtss_fan_spec_t * const spec) {
    ...
    // Set PWM frequency
    H2_WRITE_MASKED(VTSS_DEVCPU_GCB_FAN_CFG_FAN_CFG,
...
uchar h2_fan_cool_lvl_get(void) {
    ...
    // Read the register
    H2_READ(VTSS_DEVCPU_GCB_FAN_CFG_FAN_CFG, fan_cfg_reg);
...
ulong h2_fan_rotation_get() {
    ...
    ulong fan_cnt_reg;
    // Read the register
    H2_READ(VTSS_DEVCPU_GCB_FAN_STAT_FAN_CNT, fan_cnt_reg);
