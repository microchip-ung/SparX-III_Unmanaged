...
#define VTSS_MSLEEP(time) delay_1(time + 1)
#define VTSS_RC(x) x
...
void    phy_do_link_up_settings (vtss_port_no_t port_no, uchar link_mode, uchar power_mode);
void    phy_do_link_down_settings
                                (vtss_port_no_t port_no);
void    phy_power_down          (vtss_port_no_t port_no);

void    phy_receiver_reconfig   (vtss_port_no_t port_no, uchar power_mode);
